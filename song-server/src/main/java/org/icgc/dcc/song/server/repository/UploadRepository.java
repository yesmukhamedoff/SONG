...
//          "VALUES (:id, :studyId, :analysisId, :state, :payload, now())")
  default int create( String id,  CompositeStudy study,  String analysisId,
...
//  @SqlQuery("SELECT id from upload where study_id=:studyId AND analysis_id=:analysisId")
  List<Upload> findAllByStudyAndAnalysisId(CompositeStudy study, String analysisId);
  default List<String> findByBusinessKey( CompositeStudy study, String analysisId){
