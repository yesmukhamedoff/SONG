...
public enum ServerErrors implements ServerError {
  ...
  SPECIMEN_ID_NOT_DEFINED(UNPROCESSABLE_ENTITY),
  DONOR_ID_NOT_DEFINED(UNPROCESSABLE_ENTITY),
  STUDY_ID_NOT_DEFINED(UNPROCESSABLE_ENTITY),
  ...
  DUPLICATE_DONOR_IDS(CONFLICT),
  DUPLICATE_FILE_IDS(CONFLICT),
  ...
  ENTITY_NOT_IMPLEMENTED(UNPROCESSABLE_ENTITY),
